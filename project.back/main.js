...
MachineRegistry.registerElectricMachine(BlockID.woodIncubator, {
    ...
    tick:function(){
        ...
        }else this.searchBlock();    
    },
    canReceiveEnergy:function(side){
        const data = World.getBlock(this.x, this.y, this.z).data;
        const getSide = RelativeAPI.getRelativeSide;
        const sides = [1, getSide(data, 0), getSide(data, 3)];
        for(var i in sides){
            if(side == sides[i]) return false;
        }
        return true;
    },
            ...
            if(TIPS){
                ...
                if(container){
                    if(this.data.energy > 0&&this.data.signal){
                        ...
                        }else container.elements.mode.text = StringHelper.t("Idles")+" ";
...
// file: guide/pages/mechanic/naniteTrainingNode/1.js
...
// file: guide/pages/mechanic/naniteTrainingNode/2.js
...
// file: guide/pages/mechanic/armorCharger/1.js
...
// file: guide/pages/mechanic/armorCharger/2.js
...
// file: guide/pages/items/nanites.js
...
// file: guide/pages/items/components/main.js
...
// file: guide/pages/items/components/1.js
...
// file: guide/pages/items/components/2.js
...
// file: guide/pages/items/components/3.js
...
// file: guide/pages/items/components/4.js
...
// file: guide/pages/items/components/5.js
...
// file: guide/pages/items/components/6.js
...
// file: guide/pages/items/components/7.js
...
// file: guide/pages/items/components/8.js
...
// file: guide/pages/items/components/9.js
...
// file: guide/pages/items/components/10.js
...
// file: guide/pages/items/components/11.js
...
// file: guide/pages/items/components/12.js
...
// file: guide/pages/items/mechanicArmor/main.js
...
// file: guide/pages/items/mechanicArmor/adamantite/1.js
...
// file: guide/pages/items/mechanicArmor/adamantite/2.js
...
// file: guide/pages/items/mechanicArmor/sapphire/1.js
...
// file: guide/pages/items/mechanicArmor/sapphire/2.js
...
// file: guide/pages/modifications/main.js
...
// file: guide/pages/modifications/1.js
...
// file: guide/pages/modifications/2.js
...
// file: guide/pages/modifications/3.js
...
// file: guide/pages/modifications/4.js
...
// file: guide/pages/modifications/5.js
...
// file: guide/pages/modifications/6.js
...
// file: guide/pages/modifications/7.js
...
// file: guide/pages/modifications/8.js
...
// file: guide/pages/modifications/9.js
...
// file: guide/pages/modifications/10.js
...
// file: guide/pages/modifications/11.js
...
// file: guide/pages/modifications/12.js
...
// file: guide/pages/modifications/13.js
...
// file: guide/pages/modifications/14.js
...
Callback.addCallback("ItemUse", function(c, i, b){
	if(i.id == 280){
		var anime = new Animation.Item(c.x + .5, c.y + .5, c.z + .5);
		var rotation = Math.random() * 2 * Math.PI;
		var direction = Math.random() > .5 ? 1 : -1;
		var YDirection = Math.random() > .5 ? 1 : -1;
		var r = Math.random() * (1.6 - 1.4) + 1.4;
		var speed = Math.random() * (.15 - .1) + .1 * direction;
		var time = random(0, 180);
		var rotationSpeed = Math.PI * 2 / speed;
		var currentRotation = 0;
		var currentYPosition = c.y;
		anime.describeItem({
			id: 264, data: 0, count: 1,
			size: .5,
			rotation: [0, Math.PI * .5, 0],
			notRandomize: true
		});
		
		anime.loadCustom(function(){
			var crd = this.coords;
			crd.x = c.x + Math.sin(rotation) * r;
			crd.y = currentYPosition + (Math.sin(.02) * YDirection);
			crd.z = c.z + Math.cos(rotation) * r;
			currentRotation += Math.PI * 2 / rotationSpeed * -direction;
			currentYPosition = crd.y;
			if(World.getThreadTime()%30 == 0) YDirection *= -1;				
			this.setPos(crd.x, crd.y, crd.z);
