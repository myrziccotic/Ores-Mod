 ...
 * 
 * *EntityRemoved* occurs when an entity is added in the world. See 
...
declare namespace Callback {
     ...
     * coordinates
     * @param random java.lang.Random object that should be used for generation
     * process. Already seeded by appropriate values
     */
    interface GenerateChunkFunction {
        (chunkX: number, chunkZ: number, random: jobject): void
    }
...
declare namespace Recipes {
     ...
     * @returns java.lang.Collection object containing [[WorkbenchRecipe]]s
     */
    function getWorkbenchRecipesByResult(id: number, count: number, data: number): jobject;

    /**
     * Gets all avaliable recipes containing an ingredient
     * @returns java.lang.Collection object containing [[WorkbenchRecipe]]s
     */
    function getWorkbenchRecipesByIngredient(id: number, data: number): jobject;
     ...
     * @param prefix recipe prefix used for non-vanilla furnaces
     */
    function getFurnaceRecipesByResult(resultId: number, resultData: number, prefix: string): jobject;
    ...
    class WorkbenchUIHandler {
         ...
         * @param target target window's "elements" section
         * @param targetCon target container
         * @param field workbench field
         */
        constructor(target: UI.WindowElements, targetCon: UI.Container, field: WorkbenchField);
     ...
     */
    interface WorkbenchRecipe extends jobject {
        /**
         ...
         */
        getSortedEntries(): jarray<RecipeEntry>;
     ...
     */
    interface WorkbenchField extends jobject {
        /**
     ...
     */
    interface WorkbenchFieldAPI extends jobject {
     ...
     */
    interface RecipeEntry extends jobject {
...
declare namespace UI {
    ...
    class Window implements IWindow {
        ...
        /**
         * Specifies wether touch events should be handled by this window or 
        ...
        /**
         * Specifies wether the window should darken and block background. 
         * Default value is false
        ...
        /**
         * @returns scale of the unit in comparison to fullscreen window's unit
         */
        getScale(): number;

        /**
         * Overrides style properties of the current style by the values 
         * specified in the [[StyleObject]]
         * @param style style properties specified in js object. 
         */
        ...
        /**
         * Sets listener to be notified aboud window opening/closing events
         */
